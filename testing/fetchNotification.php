<?php 
    ...
    if(isset($_POST["view"]))
    {
     ...
     $query = "SELECT * FROM notifications WHERE notification_status=0 ORDER BY notification_id DESC LIMIT 5";
     ...
     $query_1 = "SELECT * FROM notifications WHERE notification_status=0";
