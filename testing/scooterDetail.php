      ...
      if ($count > 0) {
        while ($row = $results->fetch_assoc()) {
          ...
          <section class="listing-detail">
                ...
                <div class="col-md-9">
                  ...
                  <?php $currentVid = $row['vid'];
                    ...
                    <form action="stripeIPN.php?id=<?php echo $vhid; ?>" method="POST">
                      ...
                      <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key=<?php echo $stripeDetails['publishableKey'] ?> data-amount=<?php echo $row['PricePerDay'] * 100 ?> data-name=<?php echo htmlentities($row['VehiclesTitle']); ?> data-email=<?php echo htmlentities($_SESSION['email']); ?> data-description=<?php echo htmlentities($row['VehiclesBrand']); ?> data-image="https://stripe.com/img/documentation/checkout/marketplace.png" data-locale="auto" data-currency="nzd">
                      </script>
                    </form>
              <?php }
                }
            ...
            <!-- COMMENT SECTION -->
            <br>
            <h1 style="margin-left: 20px;">Add Comment</h1>
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <!-- ADD COMMENT -->
