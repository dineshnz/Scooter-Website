            ...
            <div class="page-wrapper">
              ...
              <div class="row">
                <div class="col-md-9">
                  ...
                  <!-- finding out who rented the vehicle -->
                    <?php 
                    $userSql = "SELECT * FROM users WHERE id= $userIdOfRenter";
                    $userResult = $conn-> query($userSql);
                    $userResultRow = $userResult -> num_rows;
                    
                    if ($userResultRow > 0) {
                      while($row2 = $userResult->fetch_assoc())
                        {
                           $nameOfRenter = $row2['fullname'];
                        }}?>
                  <!--Side-Bar-->
                  <aside class="col-md-3">
                    ...
                    <ul>          
                      <li><i class="fa fa-user" aria-hidden="true"></i>
                        <h5><?php echo htmlentities($nameOfRenter);?></h5>
                        <p>Rented By</p>
                      </li>
                    </ul>
                  </div>
